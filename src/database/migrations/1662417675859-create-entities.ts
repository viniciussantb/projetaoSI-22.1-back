...
export class createEntities1662417675859 implements MigrationInterface {
    name = 'createEntities1662417675859'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "productSelectionLog" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" integer, "marketProductId" integer, CONSTRAINT "PK_9493b47c57e2aee7a7d701f9994" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "productSelectionLog" ADD CONSTRAINT "FK_89c2bc6dfb3ee8d9a4d7564ed07" FOREIGN KEY ("marketProductId") REFERENCES "marketProduct"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "productSelectionLog" DROP CONSTRAINT "FK_89c2bc6dfb3ee8d9a4d7564ed07"`);
