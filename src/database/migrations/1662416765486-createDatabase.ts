...
export class createDatabase1662416765486 implements MigrationInterface {
    name = 'createDatabase1662416765486'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "nickname" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "receiveEmail" boolean NOT NULL, CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ProductSelectionLog" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientId" integer, "marketProductId" integer, CONSTRAINT "PK_3489381125425c23647909ecbf7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "productSelectionLog" ADD CONSTRAINT "FK_f94713320aa27a3239fb7d13134" FOREIGN KEY ("clientId") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "productSelectionLog" ADD CONSTRAINT "FK_c978c99d24710d59f79a16f7afc" FOREIGN KEY ("marketProductId") REFERENCES "marketProduct"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "productSelectionLog" DROP CONSTRAINT "FK_c978c99d24710d59f79a16f7afc"`);
        await queryRunner.query(`ALTER TABLE "productSelectionLog" DROP CONSTRAINT "FK_f94713320aa27a3239fb7d13134"`);
